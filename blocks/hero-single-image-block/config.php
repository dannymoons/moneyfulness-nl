...
return [
	'title' => __('Hero tekst met 1 afbeelding', 'moonsio'),
	...
	'fields' => [
		...
		[
			'key' => 'hero_single_img_content_accordion',
		...
		[
			'key' => 'hero_single_img_enable_duo_heading',
		...
		[
			...
			'conditional_logic' => [
				[
					[
						'field' => 'hero_single_img_enable_duo_heading',
						'operator' => '==',
						'value' => '0',
					],
				],
		...
		[
			'key' => 'hero_single_img_title_main',
			'label' => __('Titel', 'moonsio'),
		...
		[
			'key' => 'hero_single_img_title_after',
		...
		[
			'key' => 'hero_single_img_buttons_accordion',
		...
		[
			...
			'sub_fields' => [
				...
				[
					'key' => 'hero_single_img_open_popup',
				...
				[
					...
					'conditional_logic' => [
						[
							[
								'field' => 'hero_single_img_open_popup',
								'operator' => '==',
								'value' => '0',
							],
						],
				...
				[
					'key' => 'hero_single_img_custom_button_text',
					'label' => 'Knop tekst',
					'name' => 'button_text',
					'type' => 'text',
					'conditional_logic' => [
				...
				[
					'key' => 'hero_single_img_data_popup',
				...
				[
					'key' => 'hero_single_img_button_style',
		...
		[
			'key' => 'hero_single_img_styling_accordion',
