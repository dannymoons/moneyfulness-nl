...
return [
    ...
    'post_types' => ['page', 'project'],

    'fields' => [

        [
            'key' => 'counters_repeater_accordion',
            'label' => __('Tellers', 'moonsio'),
            'name' => 'accordion_counters',
            'type' => 'accordion',
            'multi_expand' => false,
            'open' => false,
        ],
        ...
        [
            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'name' => 'label',
                    'type' => 'text',
                    'default_value' => 'Geweldige dingen',
                    'wrapper' => [
                        'width' => '33.3',
                        'class' => '',
                        'id' => '',
        ...
        [
            'key' => 'counters_styling_accordion',
