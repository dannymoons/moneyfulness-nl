...
return [
	'title' => __('Hero berichten overzicht', 'moonsio'),
	'description' => __('Berichten overzicht met zoekfunctie', 'moonsio'),
	'category' => 'moonsio',
	...
	'fields' => [
		...
		[
			'key' => 'hero_post_search_content_accordion',
		...
		[
			'key' => 'hero_post_search_buttons_accordion',
		...
		// [
		// 	'key' => 'hero_post_search_buttons',
		// 	'label' => __('Knoppen', 'moonsio'),
		// 	'name' => 'hero_single_img_buttons',
		// 	'type' => 'repeater',
		// 	'max' => '2',
		// 	'layout' => 'block',
		// 	'subs' => [
		// 		[
		// 			'key' => 'hero_post_search_button',
		// 			'label' => 'Link',
		// 			'name' => 'link',
		// 			'type' => 'link',
		// 			'wrapper' => [
		...
		// 		[
		// 			'key' => 'hero_post_search_button_style',
		...
		// [
		// 	'key' => 'hero_post_search_styling_accordion',
		...
		// [
		// 	'key' => 'hero_post_searchbar_accordion',
		// 	'label' => __('Search Settings', 'moonsio'),
		// 	'name' => 'accordion_searchbar',
		// 	'type' => 'accordion',
		// 	'multi_expand' => false,
		// 	'open' => false,
		// ],
		// [
		// 	'key' => 'hero_post_searchbar_posttype',
		// 	'label' => __('Post Types', 'moonsio'),
		// 	'name' => 'searchbar_posttype',
		// 	'type' => 'select',
		// 	'choices' => [
		// 		'blog' => __('Blog', 'moonsio'),
		// 		'knowledge-center' => __('Kennisbank', 'moonsio'),
		...
		// ],
		// [
		// 	'key' => 'hero_post_searchbar_maxposts',
		// 	'label' => __('Maximum Results Shown', 'moonsio'),
		// 	'name' => 'searchbar_maxposts',
		// 	'type' => 'number',
		// 	'default_value' => 7,
		// 	'min' => 3,
		// 	'max' => 10,
		...
		// ],
		// [
		// 	'key' => 'hero_post_searchbar_display',
		// 	'label' => __('Search Results Display', 'moonsio'),
		// 	'name' => 'searchbar_display',
		// 	'type' => 'select',
		// 	'choices' =>
		// 	[
		// 		'all' => 'Show Results Together',
		// 		'grouped' => 'Grouped By Post Type',
		// 	],
		// 	'multiple' => 0,
		// 	'default_value' => 'all',
		// 	'return_format' => 'value',
		// ],
		// [
		// 	'key' => 'hero_post_searchbar_orderby',
		// 	'label' => __('Order Results By', 'moonsio'),
		// 	'name' => 'searchbar_orderby',
		// 	'type' => 'select',
		// 	'choices' =>
		// 	[
		// 		'relevance' => 'Relevance',
		...
		// ],
		// [
		// 	'key' => 'hero_post_searchbar_minchar',
		// 	'label' => __('Minimum Characters', 'moonsio'),
		// 	'name' => 'searchbar_minchar',
		// 	'type' => 'number',
		// 	'default_value' => 0,
		// 	'min' => 0,
		// 	'step' => 1,
		// ],
		// [
		// 	'key' => 'hero_post_searchbar_inputdelay',
		// 	'label' => __('Input Time Delay', 'moonsio'),
		// 	'name' => 'searchbar_inputdelay',
		// 	'type' => 'number',
		// 	'instructions' => 'In millisecondes',
		// 	'default_value' => 100,
		// 	'min' => 0,
		// 	'step' => 1,
		// ],
		[
			'key' => 'hero_post_searchbar_search_clone',
			'label' => __('Search', 'moonsio'),
			'name' => 'clone_search',
			'type' => 'clone',
			'clone' =>
			[
				0 => 'search_settings_fields',
			],
		],
	],
];
