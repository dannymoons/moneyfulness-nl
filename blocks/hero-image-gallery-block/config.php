...
return [
	'title' => __('Hero met gallerij', 'moonsio'),
	...
	'fields' => [
		...
		[
			'key' => 'hero_gallery_img_content_accordion',
		...
		[
			'key' => 'hero_gallery_enable_duo_heading',
		...
		[
			...
			'conditional_logic' => [
				[
					[
						'field' => 'hero_gallery_enable_duo_heading',
						'operator' => '==',
						'value' => '0',
					],
				],
		...
		[
			'key' => 'hero_gallery_img_title_pre',
		...
		[
			'key' => 'hero_gallery_img_title_main',
			'label' => __('Titel', 'moonsio'),
		...
		[
			'key' => 'hero_gallery_img_title_after',
		...
		[
			'key' => 'hero_gallery_imgages',
			'label' => __('Afbeeldingen', 'moonsio'),
			'name' => 'hero_images',
			'type' => 'gallery',
			'instructions' => '',
			'required' => 0,
		...
		[
			'key' => 'hero_gallery_img_buttons_accordion',
		...
		[
			'key' => 'hero_gallery_img_buttons',
			'label' => __('Knoppen', 'moonsio'),
			'name' => 'hero_gallery_img_buttons',
			'type' => 'repeater',
			'max' => '2',
			'layout' => 'block',
			'sub_fields' => [
				[
					'key' => 'hero_gallery_img_button',
					'label' => 'Link',
					'name' => 'link',
					'type' => 'link',
					'wrapper' => [
				...
				[
					'key' => 'hero_gallery_img_button_style',
		...
		[
			'key' => 'hero_gallery_img_styling_accordion',
